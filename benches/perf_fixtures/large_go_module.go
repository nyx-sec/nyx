...
//
// Source: gin-gonic/gin context.go (MIT-licensed); copied verbatim as a
// realistic perfhunt fixture covering many function bodies (~147 fns,
// ~1.5k lines) so per-body analysis caching is exercised at scale.
